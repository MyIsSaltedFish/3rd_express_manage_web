 ...
 * Generated at: 2019-01-13 09:52:04 UTC
...
public final class decidedzone_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>管理承包区/调度排班</title>\r\n");
      ...
      out.write("\t\t\t$.messager.alert('提示','请选择一个承包区','warning');\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\t//弹出选择菜单\r\n");
      ...
      out.write("\t\t\t//发送ajax请求 获取没有绑定承包区客户\r\n");
      out.write("\t\t\tvar url_1 = \"crm/findcusnoass\";\r\n");
      ...
      out.write("\t\t\t\t\t$(\"#noassociationSelect\").append(\"<option value='\"+id+\"'>\"\r\n");
      out.write("\t\t\t\t\t\t+name+\"</option>\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t//发送ajax请求获取绑定承包区的客户\r\n");
      out.write("\t\t\tvar url_2 = \"crm/findcusass\";\r\n");
      out.write("\t\t\tvar data={\"dzid\":rows[0].id};\r\n");
      out.write("\t\t\t$.post(url_2,data,function(data){\r\n");
      out.write("\t\t\t\t//遍历json数组\r\n");
      out.write("\t\t\t\tfor (var i = 0; i < data.length; i++) {\r\n");
      out.write("\t\t\t\t\tvar id = data[i].id;\r\n");
      out.write("\t\t\t\t\tvar name = data[i].name;\r\n");
      out.write("\t\t\t\t\tvar telephone = data[i].telephone;\r\n");
      out.write("\t\t\t\t\tname = name + \"(\"+telephone+\")\";\r\n");
      out.write("\t\t\t\t\t$(\"#associationSelect\").append(\"<option value='\"+id+\"'>\"\r\n");
      out.write("\t\t\t\t\t\t+name+\"</option>\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t$(function(){\r\n");
      ...
      out.write("\t\t\t\t\t$('#customerForm').form({    \r\n");
      out.write("\t\t\t\t\t    url:\"decidedzone/asscustomer\",    \r\n");
      ...
      out.write("\t\tfield : 'id',\r\n");
      out.write("\t\ttitle : '承包区编号',\r\n");
      out.write("\t\twidth : 120,\r\n");
      out.write("\t\talign : 'center'\r\n");
      out.write("\t},{\r\n");
      out.write("\t\tfield : 'name',\r\n");
      out.write("\t\ttitle : '承包区名称',\r\n");
      out.write("\t\twidth : 120,\r\n");
      out.write("\t\talign : 'center'\r\n");
      out.write("\t}, {\r\n");
      ...
      out.write("\t\t\turl :\"decided/find\", \r\n");
      out.write("\t\t\t\t//\"static/json/decidedzone.json\",\r\n");
      ...
      out.write("\t\t\trownumbers : true,\r\n");
      out.write("\t\t\tstriped : true,\r\n");
      out.write("\t\t\turl : \"static/json/association_subarea.json\",\r\n");
      out.write("\t\t\tcolumns : [ [{\r\n");
      out.write("\t\t\t\tfield : 'id',\r\n");
      ...
      out.write("\t\t\trownumbers : true,\r\n");
      out.write("\t\t\tstriped : true,\r\n");
      out.write("\t\t\turl : \"static/json/association_customer.json\",\r\n");
      out.write("\t\t\tcolumns : [[{\r\n");
      out.write("\t\t\t\tfield : 'id',\r\n");
      ...
      out.write("\t\t\t<div title=\"关联小区\" id=\"subArea\"\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t<!-- 添加 修改小区 -->\r\n");
      out.write("\t<div class=\"easyui-window\" title=\"承包区添加修改\" id=\"addDecidedzoneWindow\" collapsible=\"false\" minimizable=\"false\" maximizable=\"false\" style=\"top:20px;left:200px\">\r\n");
      ...
      out.write("    \t\t\t\t\t\t\tdata-options=\"valueField:'id',textField:'name',url:'static/json/standard.json'\" />  \r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr height=\"300\">\r\n");
      out.write("\t\t\t\t\t\t<td valign=\"top\">关联小区</td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<table id=\"subareaGrid\"  class=\"easyui-datagrid\" border=\"false\" style=\"width:300px;height:300px\" data-options=\"url:'static/json/decidedzone_subarea.json',fitColumns:true,singleSelect:false\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<thead>  \r\n");
      out.write("\t\t\t\t\t\t\t        <tr>  \r\n");
      ...
      out.write("\t</div>\r\n");
      out.write("\t<!-- 查询承包区 -->\r\n");
      out.write("\t<div class=\"easyui-window\" title=\"查询承包区窗口\" id=\"searchWindow\" collapsible=\"false\" minimizable=\"false\" maximizable=\"false\" style=\"top:20px;left:200px\">\r\n");
      out.write("\t\t<div style=\"overflow:auto;padding:5px;\" border=\"false\">\r\n");
      out.write("\t\t\t<form>\r\n");
      out.write("\t\t\t\t<table class=\"table-edit\" width=\"80%\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t<tr class=\"title\">\r\n");
      ...
      out.write("\t\t<div style=\"overflow:auto;padding:5px;\" border=\"false\">\r\n");
      out.write("\t\t\t<form id=\"customerForm\" action=\"decidedzone/asscustomer\" method=\"post\">\r\n");
      out.write("\t\t\t\t<table class=\"table-edit\" width=\"80%\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t<tr class=\"title\">\r\n");
